#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Copyright 2018-2019 UberNET_ .CC
# All rights reserved.
#
...
def speedtest():
    ...
    if not args.simple:
        print_('\033[1;31m>>> Downloading Binary from \033[1;37m UberNET_ .CC\033[1;m \033[1;31m for configuration...')
    try:
        config = getConfig()
    except URLError:
    ...
    if not args.simple:
        print_('\033[1;31m>>> Speedtest your Network_ by connecting to \033[1;37m UberNET_ .CC\033[1;m \033[1;31m ')
    ...
    if not args.simple:
        print_('\033[1;31m>>> We are connected... ' % config['client'])
    ...
    if args.server:
        ...
        if not args.simple:
            print_('\033[1;31m>>> We are searching for the Radius_ \033[1;m')
            print_('\033[1;31m>>> We are done! (Here is your ISP details) \033[1;m')
        best = getBestServer(servers)

    if not args.simple:
        print_(('\033[1;31m>>> ISP_ provided by: \033[1;37m%(sponsor)s\033[1;m (\033[1;37m%(name)s\033[1;m) \033[1;m[\033[1;37m%(d)0.2f km\033[1;m]\033[1;37m:\033[1;37m '
    ...
    if not args.simple:
        print_('>_ Getting_ download speed   ', end='')
    dlspeed = downloadSpeed(urls, args.simple)
    if not args.simple:
        print_()
    print_('* Your download speed: \033[1;37m%0.2f M%s/s' %
    ...
    for size in sizesizes:
        for i in range(0, 25):
            sizes.append(size)
    if not args.simple:
        print_('\033[1;31m>_ Getting_ upload speed   ', end='')
    ulspeed = uploadSpeed(best['url'], sizes, args.simple)
    if not args.simple:
        print_()
    print_('* Your upload speed: \033[1;37m%0.2f M%s/s\033[1;31m' %
...
if __name__ == '__main__':
    ...
    print_('\033[1;31m- All rights reserved (C) UberNET_ .CC \033[1;m')
